const STATUS_MAP = {
  ...
  agent_initiated:            { label: 'Agent Working',     cls: 'badge-blue'   },
  negotiating:                { label: 'Negotiating',       cls: 'badge-green'  },
  renegotiating:              { label: 'Renegotiating',     cls: 'badge-amber'  },
  pending_supplier_approval:  { label: 'Review Offer',      cls: 'badge-purple' },
  offer_ready:                { label: 'Offer Sent',        cls: 'badge-blue'   },
  buyer_review:               { label: 'Under Review',      cls: 'badge-amber'  },
  buyer_shortlisted:          { label: 'Shortlisted',       cls: 'badge-purple' },
  supplier_pending:           { label: 'Awaiting Confirm',  cls: 'badge-amber'  },
  supplier_confirmed:         { label: 'Confirmed',         cls: 'badge-green'  },
  supplier_declined:          { label: 'Declined',          cls: 'badge-red'    },
  awaiting_supplier_confirm:  { label: 'Awaiting Confirm',  cls: 'badge-amber'  },
